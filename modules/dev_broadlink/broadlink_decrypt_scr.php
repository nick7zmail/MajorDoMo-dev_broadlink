...
echo '<tt>';
$host_RM = '192.168.1.216';
$host_A1 = '192.168.1.217';
$host_SP3 = '192.168.1.218';
$host_S1 = '192.168.1.219';
$port = 80;
$timeout = 10;
...
$id = array(0, 0, 0, 0);
//сервер
$key_authorized = array(28, 177, 82, 66, 28, 177, 82, 66, 28, 177, 82, 66, 28, 177, 82, 66);
$id_authorized = array(2, 0, 0, 0);
//смартфон
$key_authorized = array(0xb7, 0xa6, 0xc6, 0x04, 0xb7, 0xa6, 0xc6, 0x04, 0xb7, 0xa6, 0xc6, 0x04, 0xb7, 0xa6, 0xc6, 0x04);
$id_authorized = array(1, 0, 0, 0);

//Discover();						//поиск устройств в сети

// расшифровка пакетов из wireshark, сюда нужно вставлять 
